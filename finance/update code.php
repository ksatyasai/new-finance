...
if(isset($_POST['submit']))
{
 ...
 $year=$d2['year'];
  ...
  $sql="UPDATE `newlist` SET `id`='$id',`name`='$name',`fathername`='$fathername',`phoneno`='$phoneno',`totalamount`='$totalamount',`paidamount`='$sum',`date`='$date',`$dat`='$value' where `id`='$id'";
  ...
  // $sql="UPDATE `newlist` SET `paidamount`='' where `id`='$id'";
  // $result=mysqli_query($conn,$sql);
  // if($result)
  // {
  //   echo "<script>alert('$id updated');window.location.href='update.php'</script>";
  // }
  // else
  // {
  //   echo "<script>alert('error occour not updated');window.location.href='update.php'</script>";
