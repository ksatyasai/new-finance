        ...
        <div class="collapse navbar-collapse icons" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              ...
              <button class="btn btn-light nav-link" onclick="">Home</button>
            </li>
            <li class="nav-item">
              <!-- <a class="nav-link" href="#" onclick="window.location.href='datalist.php'">Check Data List</a> -->
              <button class="btn btn-light nav-link" onclick="window.location.href='datalist.php'">Check Data List</button>
            </li>
            <li class="nav-item">
                <!-- <a class="nav-link" href="#" onclick="window.location.href='./update.php'">Update Data</a> -->
                <button class="btn btn-light nav-link" onclick="window.location.href='./update.php'">Update Data</button>
              </li>
              <li class="nav-item">
                <!-- <a class="nav-link" href="#" onclick="window.location.href='./paiddatalist.php'">Check Paid Data</a> -->
                <button class="btn btn-light nav-link" onclick="window.location.href='./paiddatalist.php'">Check Paid Data</button>
              </li>
              <li class="nav-item">
                <!-- <a class="nav-link" href="#" onclick="window.location.href='../logout.php'">Sign out</a> -->
                <button class="btn btn-light nav-link" onclick="window.location.href='../logout.php'">Sign out</button>
              </li>
          </ul>
        </div>
      </nav>
                    ...
                    <div class="modal-body">
                        <form class="form" action="./data.php" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class='form-control' name="paidamount" value="0">
                            </div>
                            <div class="form-group">
